 ...
 */
public class TextReferenceEditorPane extends ReferenceEditorPane<TextReferenceItem> {
    ...
    private TextReferenceEditorPane( TextReferenceItem sri ) {
        super( sri );
...
//        _textEditorScrollPane.setViewportView( _simpleTextEditor );
        ...
        _innerPanel.add( BorderLayout.CENTER, _textEditorScrollPane );
